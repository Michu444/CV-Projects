...
INPUT: In the first line: the number of consecutive lines. In the following lines after a space: n and k where n = n is the number to decompose, and k is the prime number at which to begin the split.
